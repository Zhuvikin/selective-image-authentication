...
set CLASSPATH=%APP_HOME%\lib\application.jar;%APP_HOME%\lib\commons-cli-1.4.jar;%APP_HOME%\lib\ldpc.jar;%APP_HOME%\lib\matrix.jar

@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" ru.zhuvikin.auth.app.SelectiveAuthentication %CMD_LINE_ARGS%
